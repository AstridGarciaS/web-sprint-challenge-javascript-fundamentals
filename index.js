...
//When a function is defined within another function, it creates a 
//nested function, enabling the nested function to access all the variables
// and functions defined in the outer function.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    let displayNames = [];
    zooAnimals.forEach(item => displayNames.push( 
  ...
  */
  ...
  function lowerCaseNames(array){
    let newArray = array.map(Object =>
      Object.animal_name.toLowerCase());
    return newArray;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    let lowPopulationAnimals = array.filter(
      Object => Object.population < 5);
  ...
  */
  ...
  function USApop(array){
    let total_population = array.reduce(function(acc, item){
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
console.log('Step 4-1', cuboid.volume()); // 100
console.log('Step 4-2', cuboid.surfaceArea()); // 130
